...
规则来源：docs/积分系统开发计划.md v1.2（100 积分 = 1 元）。
"""
...
class PointsConstant:
    ...
    Attributes:
        ...
        TX_USAGE_RESERVE: 生成任务预扣流水类型。
        TX_USAGE_SETTLE: 生成任务结算（多退少补）流水类型。
        TX_USAGE_REFUND: 失败退回流水类型。
    ...
    TX_USAGE_RESERVE = "USAGE_RESERVE"  # 生成任务预扣
    TX_USAGE_SETTLE = "USAGE_SETTLE"    # 生成任务结算（多退少补）
    TX_USAGE_REFUND = "USAGE_REFUND"    # 失败退回
