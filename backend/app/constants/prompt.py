...
3. 撰写正文时，按行文需要在合适位置插入图片标签，格式为 <imageN>描述</imageN>：N 为配图序号（1, 2, 3...）严格递增，标签内的"描述"为一句话简短说明该处需要什么图，便于后续据此配图。示例：<image1>俯拍视角，展示做西红柿炒鸡蛋所需的全部食材和工具，整齐摆放在木桌上</image1>，<image2>一张办理护照和签证所需材料的清单示意图，包括身份证、照片、申请表、缴费凭证等，用简洁的图标排列</image2>
